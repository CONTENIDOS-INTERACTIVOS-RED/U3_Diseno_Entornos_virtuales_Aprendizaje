        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La Unidad 3, profundiza la evaluación en ambientes digitales, destacando su rol estratégico para mejorar la calidad educativa. Se abordan tipos y enfoques de evaluación (formativa, sumativa, diagnóstica), diseño de instrumentos digitales (rúbricas, pruebas multimedia), uso de herramientas tecnológicas (Google Forms, Kahoot, Socrative), retroalimentación formativa y analítica del aprendizaje. Además, se enfatiza la seguridad digital y ética en el manejo de datos. Se promueve una evaluación coherente, inclusiva y centrada en el estudiante, con estrategias que fortalecen la autonomía y la mejora continua.
